...
import { BookOpen, Mail, Lock, ArrowRight, Github, Code, Sparkles, Layout } from "lucide-react";
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen  bg-[#080410] flex text-white font-sans overflow-hidden">
      {/* Visual Section */}
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 font-medium">
              {isLogin ? "Enter your credentials to access your dashboard." : "Start your learning journey with world-class instructors."}
            </p>
          </div>
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      <input 
                        ...
                        className="w-full px-4 py-3.5 bg-[#120B24] border border-[#2A1B4E] rounded-xl focus:border-violet-500 focus:shadow-[0_0_15px_rgba(124,58,237,0.15)] outline-none transition-all font-medium text-white placeholder:text-slate-600 text-sm"
                      />
                    </div>
                  </div>
                )}
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {isLogin && <a href="#" className="flex justify-between items-center">
                ...
                <div className="pt-4">
                  <button className="w-full flex items-center justify-center space-x-2 bg-violet-600 hover:bg-violet-500 text-white py-4 rounded-xl font-bold text-sm tracking-widest uppercase transition-all shadow-[0_0_20px_rgba(124,58,237,0.3)] hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] group mt-6">
